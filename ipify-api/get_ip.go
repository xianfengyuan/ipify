...
// GetIPText return a user's public facing IP address.
//
// By default, it will return the IP address in plain text.
func GetIPText(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
...
func GetIP(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
	...
	fmt.Fprintf(w, "<!DOCTYPE html><html><body><h1>Welcome to ipify mirror: "+ip+"</h1></body></html>")
}
